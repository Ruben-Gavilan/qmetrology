# Script para probar la convergencia de la QFI en función del cutoff y del dl
...
n_GKP=2.76 # Número de fotones del estado
n=5
...
#grid()
#title("QFI Convergence")
#savefig("sv_dl_convergence_5.png")
